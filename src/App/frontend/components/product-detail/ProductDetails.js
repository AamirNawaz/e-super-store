...
function ProductDetails(props) {
    ...
    const item = props.products.find((prod) => prod._id === productID);
    if (item) {
        return (
            <React.Fragment>
                <ToastContainer
                                ...
                                <div className="card">
                                    <article className="gallery-wrap">
                                        <div className="img-big-wrap">
                                            ...
                                            <div> <a href="/"><img src={REACT_APP_ENV === 'Development' ? DEV_NODE_IMAGES_PATH + `${item.image}` : NODE_IMAGES_PATH + `${item.image}`} alt="" /></a></div>
                                        </div>
                                ...
                                <article className="product-info-aside">
                                    ...
                                    <div className="form-row  mt-4">
                                        ...
                                        <div className="form-group col-md">
                                            ...
                                            &nbsp;
                                            &nbsp;
                                            <button className="btn btn-info" onClick={() => alert('comming soon')}>
        ...
        return <Redirect to="/shope-products" />
    }
