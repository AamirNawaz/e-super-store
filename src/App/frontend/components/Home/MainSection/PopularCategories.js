            ...
            <div className="col-md d-none d-lg-block flex-grow-1">
                <aside className="special-home-right">
                    ...
                    <div className="card-banner border-bottom">
                        ...
                        <img src='./image1' alt="item 1" height={80} className="img-bg" />
                    </div>
                    <div className="card-banner border-bottom">
                        <div className="py-3" style={{ width: '80%' }}>
                        ...
                        <img src="./img2" alt="item 2" height={80} className="img-bg" />
                    </div>
                    <div className="card-banner border-bottom">
                        <div className="py-3" style={{ width: '80%' }}>
                        ...
                        <img src="./img3" alt="item 3" height={80} className="img-bg" />
                    </div>
                </aside>
            </div> {/* col.// */}
        </React.Fragment>
